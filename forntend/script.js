(function(){
  ...
  var navLinks = document.querySelectorAll('nav.primary a[data-nav]');
  ...
  function routeFromHash(){
    ...
    if(hash === 'about-anchor' || hash === 'contact-anchor'){
      showPage('landing');
      setTimeout(function(){
  ...
  document.getElementById('footer-terms').addEventListener('click', function(e){e.preventDefault(); alert('Terms & Conditions page — plug in your policy text here.');});
  document.getElementById('footer-contact').addEventListener('click', function(e){e.preventDefault(); alert('Contact form — hook this up to your backend or a mailto link.');});
})();